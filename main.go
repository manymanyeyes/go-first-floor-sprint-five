...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return (CaloriesMeanSpeedMultiplier*r.TrainingInfo().Speed + CaloriesMeanSpeedShift) * r.Weight / MInKm * float64(r.Duration) * MinInHours
}
...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	return ((CaloriesMeanSpeedMultiplier*w.Weight + (math.Pow(w.TrainingInfo().Speed, 2)/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * float64(w.Duration) * MinInHours)
}
